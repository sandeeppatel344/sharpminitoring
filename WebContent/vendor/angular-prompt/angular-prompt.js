...
angular.module('cgPrompt').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('angular-prompt.html',
    ...
    "        <button ng-repeat=\"button in options.buttons track by button.label\" class=\"btn btn-raised btn-default {{button.class}}\" ng-class=\"{'btn-warning':button.primary}\" ng-click=\"buttonClicked(button)\">{{button.label}}</button>\n" +
    "    </div>\n" +
    "</div>"
  );
